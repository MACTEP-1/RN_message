...
const RenderMessage = ({ message, username }: Props) => {
    ...
    let avatarImage = message.image ?? unknownAvatarImage;
    ...
    return (
      <Animated.View
        style={[
          Styles.flatListItem,
          { borderColor: username == message.by ? "green" : "blue" },
      ...
      >
        <View style={Styles.messageHeader}>
          ...
          <Text style={Styles.smallItalicText}>
            {message.by} at {new Date(message.timeStamp).toLocaleTimeString()}
          </Text>
        </View>
